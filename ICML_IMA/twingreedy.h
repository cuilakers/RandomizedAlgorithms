//
// Created by CLAKERS on 2021/1/22.
//

#ifndef ICML_IMA_TWINGREEDY_H
#define ICML_IMA_TWINGREEDY_H
#include "read_data.h"
pair<double,long long int> twingreedy(double eps,int max_image)
{
    ...
    //int r=category*per_category_max;
    int r=max_image;
        ...
        for(int element=0;element<node_num;element++)
        {
            if(available[element]==1)//if e\notin S_1 or S_2
            {
                ...
                if(max_marginal>=tau)
                {
                    ...
                    S[max_solution].category_sum[lable[element]]++;//S+e\in I
    ...
    cout<<"Twingreedy & max_image: "<<max_image<<endl;
